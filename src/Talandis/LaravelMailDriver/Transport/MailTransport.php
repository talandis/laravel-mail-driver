...
namespace Talandis\LaravelMailDriver\Transport;
...
class MailTransport implements Swift_Transport
{
     ...
     *
     * @param MailInvoker  $invoker
     * @param Swift_Events_EventDispatcher $eventDispatcher
     */
    public function __construct(MailInvoker $invoker, Swift_Events_EventDispatcher $eventDispatcher)
    {
